      ...
      {goals.length === 0 ? (
        <Card>
          <div className="goals-empty">
            ...
            <p>Définissez des objectifs d'épargne pour atteindre vos projets.</p>
            <Button onClick={() => setIsModalOpen(true)}>
              Créer un objectif
            </Button>
          </div>
              ...
              <Card key={goal.id}>
                <div className="goal-card">
                  <div className="goal-card-header">
                    <div className={`goal-card-icon ${isCompleted ? 'completed' : ''}`}>
                      {isCompleted ? '✅' : '🏆'}
                    </div>
                    <button
                  ...
                  <div className="goal-card-info">
                    ...
                    <span className="goal-card-info-value">{account?.name || 'Inconnu'}</span>
                  </div>
                    ...
                    <div className="goal-card-info">
                      ...
                      <span className="goal-card-info-value">
                        ...
                        {daysRemaining !== null && daysRemaining > 0 && (
                          <span className="goal-card-days"> ({daysRemaining}j restants)</span>
                        )}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="goal-card-progress">
                    <div className="goal-card-progress-bar">
                      <div
                        className={`goal-card-progress-fill ${isCompleted ? 'completed' : ''}`}
